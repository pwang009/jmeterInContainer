...
# export TARGET_HOST="lotuscacheapi-qa.azurewebsites.net"
# export TARGET_PORT="443"
# export TARGET_PROTOCOL="https"
# export TARGET_PATH="/swagger/index.html"
# export TARGET_KEYWORD="CASalesTaxRateApi"
...
./run.sh -Dlog_level.jmeter=DEBUG \
	-JTARGET_HOST=${TARGET_HOST} -JTARGET_PORT=${TARGET_PORT} -JTARGET_PROTOCOL=${TARGET_PROTOCOL}\
